package no.nowak.core.infrastructure.mail

import no.nowak.core.infrastructure.Paths.USER_PATH
import no.nowak.core.user.User
import no.nowak.core.user.UserApi.Companion.ACTIVATION_KEY
import no.nowak.core.user.UserApi.Companion.ACTIVATION_PATH
