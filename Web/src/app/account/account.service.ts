...
export class AccountService {
  ...
  registerAccount(registerData: RegisterDTO, confirmPassword: string) {
    ...
    this._http.post('http://a75192fc.eu.ngrok.io/users/register',
  ...
  obtainAccessToken(loginData) {
    ...
    this._http.post('http://a75192fc.eu.ngrok.io/oauth/token', params.toString(), options)
      .map(res => res.json())
      .subscribe(
  ...
  getUserInfo(): Observable<UserDTO> {
    ...
    return this._http.get('http://a75192fc.eu.ngrok.io/users/info', {headers: headers})
  ...
  updateUser(userDTO: UserDTO): Observable<UserDTO> {
    ...
    return this._http.put('http://a75192fc.eu.ngrok.io/users/info', JSON.stringify(userDTO), {headers: headers})
      .map((res: any) => res.json())
      .catch((error: any) => Observable.throw(error.json()));
  }
